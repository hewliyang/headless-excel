...
Pivot tables (create / read / update / delete, fluent + declarative) are covered in [pivot.md](pivot.md). Read it when the task involves pivots.
...
# Pivot tables — see pivot.md for the full add_pivot / read / update / delete API
